...
RUN mkdir -p /root/scripts/ldap_manager/ver.1.0/
RUN mkdir /root/bin/
RUN cp -R /sh_tool/bin/   /root/scripts/ldap_manager/ver.1.0/
RUN cp -R /sh_tool/conf/  /root/scripts/ldap_manager/ver.1.0/
RUN cp -R /sh_tool/log/   /root/scripts/ldap_manager/ver.1.0/
RUN rm -Rf /sh_tool/
RUN chmod -R 755 /root/scripts/ldap_manager/ver.1.0/
RUN ln -s /root/scripts/ldap_manager/ver.1.0/bin/ldap_manager.sh /root/bin/ldap_manager
RUN tree /root/scripts/ldap_manager/ver.1.0/
