...
Copyright
    ...
    ldap_manager is distributed in the hope that it will be useful, but
...
project: str = 'ldap_manager'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0'
release: str = 'https://github.com/vroncevic/ldap_manager/releases'
...
htmlhelp_basename: str = 'ldap_managerdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'ldap_manager.tex', 'ldap_manager Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'ldap_manager', 'ldap_manager Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'ldap_manager', 'ldap_manager Documentation', author,
    'ldap_manager', 'One line description of project.', 'Miscellaneous'
)]
